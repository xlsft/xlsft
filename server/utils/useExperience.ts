...
import _t from '~~/i18n/locales'

export const useExperience = (event: H3Event, _from: string | Date, _to?: string | Date) => {
    
    const locale = getRouterParam(event, 'locale') as keyof typeof _t
    const t = _t[locale]
