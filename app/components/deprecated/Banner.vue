...
<template>
    <div class="print:hidden w-dvw max-lg:flex-col fixed bottom-0 left-0 flex items center z-[9] bg-black border-t! items-center justify-between max-sm:p-[12px] max-sm:gap-[12px] p-[24px] gap-[24px]" :class="`${state === null ? 'opacity-0! transition-none!' : 'duration-500 transition-opacity'} ${state === true ? 'opacity-100!' : 'opacity-0! pointer-events-none! *:pointer-events-none'}`">
