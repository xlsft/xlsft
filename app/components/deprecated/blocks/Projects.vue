<script setup lang="ts">
    ...
    const items = computed<{ id: string, link: string, tags: string[] }[]>(() => [
        { id: 'proxy', link: 'https://proxy.xlsft.ru', tags: ['featured'] },
        { id: 'photon', link: 'https://github.com/xlsft/photon', tags: ['featured', 'oss'] },
        { id: 'elsled', link: 'https://els-led.ru', tags: ['projects'] },
        { id: 'worker', link: 'https://github.com/xlsft/worker', tags: ['featured', 'oss'] },
        { id: 'ained_widget', link: '/demo/ained_widget', tags: ['projects'] },
        { id: 'ained_developer', link: 'https://developer.ained.ru/', tags: ['projects'] },
        { id: 'briskly_business', link: 'https://briskly.business', tags: ['projects'] },
        { id: 'pixelbattle', link: '/pixelbattle', tags: ['featured', 'oss', 'fun'] },
        { id: 'ained_b24', link: 'https://www.bitrix24.ru/apps/app/ained.ained_chess', tags: ['projects'] },
        { id: 'work_russia', link: 'https://guide.cznnew.ru/', tags: ['projects'] },
        { id: 'xlsft_nuxt', link: 'https://jsr.io/@xlsft/nuxt', tags: ['featured', 'oss'] },
        { id: 'ained_widget_bot', link: 'https://t.me/ained_widget_bot', tags: ['projects'] },
        { id: 'smartshell_sdk', link: 'https://smartshell.xlsft.ru', tags: ['oss'] },
        { id: 'xlkbd', link: 'https://github.com/xlsft/xlkbd', tags: ['oss', 'fun'] },
        { id: 'htsx', link: 'https://github.com/xlsft/htsx', tags: ['oss'] },
        { id: 'xlui', link: 'https://github.com/xlsft/ui', tags: ['oss'] },
        { id: 'gizmo_parser', link: 'https://github.com/xlsft/gizmo-parser', tags: ['oss'] },
        { id: 'minjust_parser', link: 'https://github.com/xlsft/minjust_parser', tags: ['oss', 'fun'] },
        { id: 'yasearch', link: 'https://addons.mozilla.org/ru/firefox/addon/yasearch/', tags: ['oss','popular'] },
        { id: 'cyber_bot', link: 'https://github.com/xlsft/cyber-bot', tags: ['oss', 'fun'] },
    ])
